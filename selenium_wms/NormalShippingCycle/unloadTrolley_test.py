...
with open(r"C:\\jenkingsProject\\Android_automation\\main\\NormalShippingCycle\\reports\\share_data\\Trolley_list.txt", "r") as f:
    Trolley = f.read().strip()
Trolley = ast.literal_eval(Trolley)

container_table = pd.read_excel(
    "C:\\jenkingsProject\\Android_automation\\main\\NormalShippingCycle\\reports\\tables\\containers_table.xlsx",
