...
def integration():
    ...
    try:
        with open(r"C:\\jenkingsProject\\Android_automation\\main\\NormalShippingCycle\\reports\\share_data\\quantity.txt", "r") as f:
    ...
    try:
        ...
        with open(r"C:\\jenkingsProject\\Android_automation\\main\\NormalShippingCycle\\reports\\share_data\\PO_number.txt", "w") as f:
            f.write(po)
