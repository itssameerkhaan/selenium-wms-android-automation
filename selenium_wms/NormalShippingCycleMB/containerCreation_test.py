...
def ContainerCreation():
    ...
    try :
        ...
        while i<=2:
            ...
            i=i+1
        with open(r"C:\\jenkingsProject\\Android_automation\\main\\NormalShippingCycleMB\\reports\\share_data\\batch.txt", "w") as f:
            f.write(str(batches))
        with open(r"C:\\jenkingsProject\\Android_automation\\main\\NormalShippingCycleMB\\reports\\share_data\\quantity.txt", "w") as f:
        ...
        for index,batche in enumerate(batches):
            ...
            path = fr"C:\jenkingsProject\Android_automation\main\NormalShippingCycleMB\reports\tables\containers_{index}.xlsx"
